...
4. With `T-500` and `T-603` fixed, resume the critical path at `T-400` for the mc-router contract and unblock `T-401` through `T-403`, then continue into `T-501`.
