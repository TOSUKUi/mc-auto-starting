...
- Do not add monitoring dashboards, audit-log browsing screens, or unknown-hostname analytics unless the user explicitly reintroduces them.
...
4. With `T-501` fixed, continue on the server-management critical path at `T-502`, `T-503`, `T-504`, and `T-604`.
