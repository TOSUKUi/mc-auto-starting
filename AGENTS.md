...
- `T-1114` is next: startup settings are being reconsidered as create-time defaults only, with mutable server-property changes moving away from Rails desired-state editing and toward structured allowlisted RCON actions on detail.
