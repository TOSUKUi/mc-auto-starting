...
4. Continue from `T-106` with the authorization framework and policies, keeping Rails built-in authentication and Pundit-first authorization as the current baseline.
