...
- `T-1010` is now fixed at the contract layer, and `T-1011` now surfaces player count in the active server screens; the next implementation step is `T-1012` for recent-log / bounded-command browser surfaces
