...
- The next implementation step is `T-1104` for the per-runtime version-source/display contract cleanup before the remaining runtime-catalog follow-up closes cleanly
