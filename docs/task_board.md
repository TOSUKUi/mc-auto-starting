...
- The first live-source attempt should use `https://piston-meta.mojang.com/mc/game/version_manifest_v2.json` for `vanilla` and `https://gist.githubusercontent.com/osipxd/6119732e30059241c2192c4a8d2218d9/raw/55cb9f4358e990ecf838a8206e95394d268444e8/paper-versions.json` for `paper`.
