...
| T-1023 | P9 | Add whitelist management UI to the server detail page | T-1021,T-1022,T-505 | done | Authorized users can view running-server whitelist state and perform add/remove/on/off/reload actions with clear success/failure feedback, while stopped servers show a non-interactive explanation instead of mutation controls |
