...
- `T-1025` is the immediate whitelist follow-up: make running-server RCON apply and start/restart reconciliation reliable end-to-end, with verified command/response handling and clear saved-but-not-live-applied failure reporting.
