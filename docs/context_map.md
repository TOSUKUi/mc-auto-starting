...
- `docs/access_policy_and_quota_contract.md`
  Use for the active global user types, invitation authority, reader read-only expectations, and the operator-scoped `5120 MB` server-create quota fixed by `T-1014`.
...
- `T-1014` is complete: global user types, invitation authority, reader read-only behavior, and the operator-scoped `5120 MB` create quota are now fixed in `docs/access_policy_and_quota_contract.md`.
