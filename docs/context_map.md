...
- `T-1110` is complete: startup-setting candidates are now grouped in `docs/server_startup_settings_candidates.md`, with the first recommended batch centered on `difficulty`, `max_players`, `motd`, `pvp`, and `gamemode`.
