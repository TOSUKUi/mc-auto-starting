...
- The next implementation critical path starts at `T-1011` for operator-facing player-count visibility, with browser-side log / command work following at `T-1012`.
